...
tar -xvf ${package_dir}/Centos-7.9/base.tar /opt/repo/Centos
tar -xvf ${package_dir}/Centos-7.9/extras.tar /opt/repo/Centos
tar -xvf ${package_dir}/Centos-7.9/updates.tar /opt/repo/Centos
